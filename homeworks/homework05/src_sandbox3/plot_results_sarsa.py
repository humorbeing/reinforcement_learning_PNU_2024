...
path_list = [
    ['logs/e10_return.npy', 'epsilon 10%'],
    # ['logs/f1_return.npy', 'line 0.9-0.05'],
    # ['logs/f2_return.npy', 'J-curve 0.99-0.05'],
    ['logs/f3_return.npy', 'f3'],
    # ['logs/f4_return.npy', 's-curve 0.6-0.05'],
    ['logs/f5_return.npy', 'f5'],
    # ['logs/f6_return.npy', 'f6'],
    # ['logs/f7_return.npy', 'f7'],
    # ['logs/f8_return.npy', 'f8'],
    ['logs/f10_return.npy', 'f10'],
    ['logs/f11_return.npy', 'f11'],
]
...
plt.legend()
plt.title('Average of Episodic Return')
# plt.plot(x, t_median)
# plt.plot(x, e_median)
# plt.plot(x, f_median)
