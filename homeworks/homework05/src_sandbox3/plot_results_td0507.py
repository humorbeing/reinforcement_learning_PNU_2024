...
f4_mean = np.mean(f4, 0)
f5_mean = np.mean(f5, 0)
# e_mean = np.mean(ee, 0)
# f_mean = np.mean(ff, 0)
...
f4_2 = smooth(f4_mean,15)[:cut]
f5_2 = smooth(f5_mean,15)[:cut]
...
plt.plot(x_cut, t1_2, label='e10')
plt.plot(x_cut, t3_2, label='f1')
plt.plot(x_cut, t5_2, label='f2')
plt.plot(x_cut, t7_2, label='f3')
plt.plot(x_cut, f4_2, label='f4')
plt.plot(x_cut, f5_2, label='f5')
